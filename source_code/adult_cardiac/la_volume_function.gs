/**
 * @file la_volume_function.gs
 * @description Handles requests for the LA_VF (Left Atrial Volume & Function) domain.
 */

/**
 * Handles GET requests for the 'LA_VF' domain.
 ...
 */
function handleRequest_la_vf(e, SPREADSHEET_ID) {
  const SHEET_NAME = 'adult_cardiac.la_volume_function';
